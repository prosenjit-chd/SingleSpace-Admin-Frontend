                        ...
                        {!admin ?
                            (
                                ...
                                <>
                                    ...
                                    <MenuItem icon={<BsFillCartFill />}> <Link activeStyle={activeStyle} to={`/teams`}>Manage Teams</Link></MenuItem>
                                    <MenuItem icon={<BsFillCartFill />}> <Link activeStyle={activeStyle} to={`/reviews`}>Manage Review</Link></MenuItem>
                                    <MenuItem icon={<FaUserTie />}> <Link activeStyle={activeStyle} to={`/addprojects`}>Add Projects</Link></MenuItem>
                                    <MenuItem icon={<FaUserTie />}> <Link activeStyle={activeStyle} to={`/addreview`}>Add Review</Link></MenuItem>
                                    <MenuItem icon={<FaUserTie />}> <Link activeStyle={activeStyle} to={`/addteams`}>Add Teams</Link></MenuItem>

                                    <MenuItem icon={<BsFillInboxesFill />}> <Link activeStyle={activeStyle} to={`/utilities`}>Manage Utilities</Link></MenuItem>
                                    <MenuItem icon={<BsFillGearFill />}> <Link activeStyle={activeStyle} to={`/addutilities`}>Add Utilities</Link></MenuItem>
                                </>
                            )
                        }
